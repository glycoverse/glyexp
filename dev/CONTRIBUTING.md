# Contributing to glyexp

This outlines how to propose a change to glyexp. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glyexp", fork = TRUE)`.
...
Please note that the glyexp project is released with a [Contributor Code
of Conduct](https://glycoverse.github.io/glyexp/dev/CODE_OF_CONDUCT.md).
