...
test_that("data.frames as input data works", {
  ...
  exp <- experiment(expr_mat, sample_info_df, var_info_df)
...
test_that("creating experiment with missing samples in `sample_info`", {
  ...
  expect_snapshot(experiment(expr_mat, sample_info, var_info), error = TRUE)
})
...
test_that("only one sample still works", {
  ...
  expect_snapshot(experiment(expr_mat, sample_info, var_info), error = FALSE)
})
...
test_that("no variable works", {
  ...
  expect_snapshot(experiment(expr_mat, sample_info, var_info))
})
