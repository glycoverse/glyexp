...
> **Lifecycle:** `experiment()` is deprecated. For new work, create a
> `GlycomicSE()` or `GlycoproteomicSE()` object instead. This legacy vignette is
> retained only to support migration of existing code.
