...
Notice that row names in `rowData()` and column names in `colData()`
match the row and column names in the assay.
...
```{r}
subset_exp <- filter_obs(real_exp, group == "H")
```
